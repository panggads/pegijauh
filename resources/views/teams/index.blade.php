    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <div class="flex items-center gap-x-3">
                <h2 class="text-lg font-medium text-gray-800 dark:text-white">Data Team</h2>

                <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{{ count($teams); }} Team</span>
            </div>

            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Menampilkan semua data Team</p>
        </div>

        <div class="mt-4 md:mt-0">
            <a href="{{ route('team.create') }}" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-sky-600 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                        ...
                                        <div id="dropdownDots-{{$data->id}}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                                                <li>
                                                    ...
                                                    <a href="{{ route('team.show', $data->id) }}" class="my-auto flex px-4 py-2 hover:bg-gray-100">
                                                ...
                                                <li>
                                                    ...
                                                    <form id="delete-form-{{$data->id}}" action="{{ route('team.destroy', $data->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
